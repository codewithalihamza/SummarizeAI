          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                By accessing and using SummarizeAI's AI-powered PDF summarization service, you agree to be bound by
                these Terms of Service and all applicable laws and regulations. These terms govern your use of our
                platform, including document upload, processing, and summary generation features. If you do not agree
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  SummarizeAI provides an AI-powered platform that allows users to upload PDF documents and receive
                  intelligent summaries, key insights, and analysis. Our service includes:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>Premium features including advanced analysis and export options</li>
                  <li>User dashboard for managing documents and summaries</li>
                </ul>
                <p>
                  While we strive to provide accurate and useful summaries, AI-generated content may contain errors
                  or omissions. Users should review and verify important information independently.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  To access SummarizeAI's features, you must create an account with accurate, complete, and current
                ...
                <p>
                  Failure to maintain accurate account information or misuse of the service may result in
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  When using SummarizeAI, you agree not to:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>Upload documents containing personal information of others without consent</li>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <ul className="list-disc list-inside space-y-2">
                  <li>Free accounts include basic summarization with usage limits</li>
                  <li>Premium subscriptions provide unlimited processing and advanced features</li>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">6. Document Processing and Data</h2>
              <div className="space-y-4 text-gray-300">
                <p>
                  By uploading documents to SummarizeAI:
                </p>
                <ul className="list-disc list-inside space-y-2">
                  <li>You grant us permission to process and analyze your documents</li>
                  <li>You confirm you have the right to upload and process the content</li>
                  <li>You understand that original PDFs are deleted within 24 hours</li>
                  <li>Generated summaries remain associated with your account</li>
                  <li>You retain ownership of your original content and generated summaries</li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  The SummarizeAI platform, including its AI models, algorithms, design, and functionality,
                  is owned by SummarizeAI and protected by intellectual property laws. You retain ownership
                  of your uploaded documents and generated summaries.
                </p>
                <p>
                  We grant you a limited, non-exclusive license to use our service according to these terms.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  SummarizeAI provides AI-generated content "as is" without warranties of accuracy, completeness,
                  or reliability. We are not liable for:
                </p>
                <ul className="list-disc list-inside space-y-2">
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <ul className="list-disc list-inside space-y-2">
                  ...
                  <li>Upon termination, your access to summaries will be removed</li>
                </ul>
                <p>
                  You may export your data before termination through your account settings.
                </p>
              </div>
            </section>
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                significant changes via email or service notifications. Continued use of SummarizeAI
