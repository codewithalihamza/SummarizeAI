          ...
          <div className="space-y-8">
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                By accessing and using SummarizeAI, you agree to be bound by
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  ...
                  SummarizeAI for personal, non-commercial transitory viewing
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  SummarizeAI provides AI-powered document summarization
                  services. While we strive for accuracy, we do not guarantee
                  that the summaries will be error-free or meet your specific
                  requirements.
                </p>
                <p>
            ...
            <section>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  ...
                  to pay all fees in accordance with the pricing and payment
                  terms presented to you for the Service.
                </p>
                <p>
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                functionality are owned by SummarizeAI and are protected by
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                In no event shall SummarizeAI, nor its directors, employees,
            ...
            <section>
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                Terms on this page. You are advised to review these Terms
