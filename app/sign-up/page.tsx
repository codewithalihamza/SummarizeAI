            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl border border-[#4F6BFF]/20 p-8 shadow-xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="flex items-center text-sm">
                            ...
                            <label htmlFor="terms" className="ml-2 text-gray-300">
                                I agree to the{" "}
                                <Link href="/terms" className="text-[#4F6BFF] hover:text-[#4F6BFF]/80 transition-colors">
                                    Terms of Service
                                </Link>{" "}
                                and{" "}
                                <Link href="/privacy" className="text-[#4F6BFF] hover:text-[#4F6BFF]/80 transition-colors">
                                    Privacy Policy
                                </Link>
                            </label>
                        </div>
                    ...
                    <p className="mt-6 text-center text-sm text-gray-400">
                        ...
                        <Link href="/sign-in" className="text-[#4F6BFF] hover:text-[#4F6BFF]/80 transition-colors">
                            Sign in
                        </Link>
                    </p>
                </div>
