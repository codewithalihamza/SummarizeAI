    ...
    <main className="relative min-h-screen bg-black text-white overflow-hidden">
      ...
      <section className="relative flex flex-col items-center justify-center p-8 pt-32 pb-20 max-w-7xl mx-auto text-center">
        ...
        <div className="group relative flex items-center gap-3 rounded-full border border-[#4F6BFF]/30 bg-black/60 px-8 py-4 transition-all duration-500 hover:border-[#4F6BFF] hover:bg-black/80 hover:shadow-xl hover:shadow-[#4F6BFF]/25 backdrop-blur-md mb-8">
          ...
          <p className="text-sm font-semibold text-gray-200">Powered by Advanced AI Technology</p>
        ...
        <div className="space-y-6 mb-12">
          ...
          <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Save hours of reading time with our AI-powered summarization. Upload any PDF and get instant,
            accurate summaries with key insights highlighted.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience the power of AI-driven document analysis with features designed for efficiency and accuracy.
            </p>
          </div>
            ...
            {[
              {
                ...
                description: "Get summaries in seconds, not hours. Our AI processes documents instantly.",
              ...
              },
              {
                ...
                description: "Download summaries in multiple formats: PDF, Word, or Markdown.",
                color: "from-blue-400 to-indigo-500"
              },
              {
                icon: Lightbulb,
                title: "Smart Insights",
                description: "AI identifies key themes, important points, and actionable insights.",
                color: "from-purple-400 to-pink-500"
              },
              {
                icon: TrendingUp,
                title: "Accuracy Focused",
                description: "Advanced language models ensure precise and contextual summaries.",
              ...
              >
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#4F6BFF]/5 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className={`relative w-16 h-16 rounded-2xl bg-gradient-to-br ${feature.color} p-3 mb-6 group-hover:scale-110 transition-transform duration-300`}>
      ...
      <section className="relative py-20 px-8 bg-gradient-to-b from-black to-gray-900/50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6">
              Simple. Fast. <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#4F6BFF] to-[#6B7FFF]">Effective.</span>
            </h2>
            <p className="text-xl text-gray-300">Get started in just three easy steps</p>
          </div>
            ...
            {[
              {
                ...
                description: "Drag and drop your document or click to upload. We support all PDF formats.",
                icon: FileText
              },
              {
                step: "02",
                title: "AI Processing",
                description: "Our advanced AI analyzes your document and extracts key information.",
                icon: Sparkles
              },
              {
                step: "03",
                title: "Get Your Summary",
                description: "Receive a comprehensive summary with insights and export options.",
                icon: CheckCircle
              },
            ].map((step, index) => (
              <div key={index} className="relative text-center group">
                <div className="relative inline-flex items-center justify-center w-20 h-20 rounded-full bg-gradient-to-br from-[#4F6BFF] to-[#6B7FFF] mb-6 group-hover:scale-110 transition-transform duration-300">
                  ...
                  <div className="absolute -top-2 -right-2 w-8 h-8 rounded-full bg-black border-2 border-[#4F6BFF] flex items-center justify-center">
                    <span className="text-xs font-bold text-[#4F6BFF]">{step.step}</span>
                  </div>
                </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <div className="relative p-12 rounded-3xl border border-[#4F6BFF]/20 bg-black/40 backdrop-blur-xl">
            ...
            <p className="relative text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Join thousands of professionals who save time every day with SummarizeAI.
            </p>
